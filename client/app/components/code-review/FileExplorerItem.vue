...
} from "../../composables/code-review/useFileExplorerItem";
		...
		>
			...
			>
				...
				<span
					...
					class="w-4 h-4 flex items-center justify-center text-slate-400 transition-all duration-200 shrink-0 hover:text-white"
				...
				<span
					v-if="fileContainsAnyComments(currentNode.path)"
